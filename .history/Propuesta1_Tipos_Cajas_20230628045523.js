...
d3.csv("pokemon.csv").then(data => {
    ...
    const zoom = d3.zoom()
        ...
        .translateExtent([[0, 0], [width-500, height]]) // this restricts the panning to the SVG area only
        .extent([[0, 0], [width, height]]) // this sets the initial zoom area to the full SVG area
        .on("zoom", zoomed);
